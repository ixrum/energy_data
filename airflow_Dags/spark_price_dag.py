...
#        "/Users/izrumhaider/Desktop/new/price_data_ingestion_f.py"  # Replace with your actual script path
#    ], check=True)
...
#    )
    run_script = BashOperator(
        task_id='Run_PriceDataIngestion_Script',
        bash_command='python ~/Desktop/new/price_data_ingestion_f.py'
    )
