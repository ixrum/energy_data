...
delta_path = os.path.join(os.path.expanduser("~"), "public_power_table")

# Read data from Delta table
input_df = spark.read.format("delta").load(delta_path)
...
# Delta table path for saving the distinct production types
